...
## Environments
- Preview: https://main--aem-pureencap--blefebvre.aem.page/
- Live: https://main--aem-pureencap--blefebvre.aem.live/
...
1. Open the `aem-pureencap` directory in your favorite IDE and start coding :)
